...
/**
 * Sample SOAP client using CXF.
 */
public class ClientWithComplexType {
   /* private static final Logger log = LoggerFactory.getLogger(ClientWithComplexType.class);
    public void executeSOAPClient() throws Exception {
        try {
            String inputMsg="<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" " +
                    ...
                    "   <soapenv:Body>\n" +
                    "      <sch:CustomerInfo>\n" +
                    "         <sch:Name>cv</sch:Name>\n" +
                    "         <sch:Email>n@gmail.com</sch:Email>\n" +
                    "         <sch:CustomerID>12</sch:CustomerID>\n" +
                    "         <sch:CreditRating>1</sch:CreditRating>\n" +
                    "      </sch:CustomerInfo>\n" +
                    "   </soapenv:Body>\n" +
                    "</soapenv:Envelope>";
            ...
            URL wsdlURL = new URL("http://10.100.4.192:9763/services/CustomerInfoService?wsdl");
            ...
            String operation = "getCustomerSSN";
            ...
            try {
                ...
                String responseMessageType = "CustomerSSN";
                String responseBody = JsonPath.read(jsonStr, "Envelope.Body."+responseMessageType+".SSN").toString();
